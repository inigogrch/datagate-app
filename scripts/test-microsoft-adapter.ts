...
async function main() {
  console.log('🧪 Testing Microsoft Excel & Power BI Blog Adapter...')
  ...
  try {
    ...
    // Test the adapter
    console.log('🔄 Fetching and parsing Microsoft Excel & Power BI Blog...')
    ...
    console.log(`   • Contains Microsoft-specific keywords: ${hasMicrosoftKeywords ? '✅' : '❌'}`)
    
    console.log('\n🎉 Microsoft adapter test completed successfully!')
